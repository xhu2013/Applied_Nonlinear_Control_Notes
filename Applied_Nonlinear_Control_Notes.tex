...
\noindent {\bf Multiple Equilibrium Points}
...
%
%当考虑$\dot{x}=-x+x^2$时，解得到$x(t)-\frac{x_0e^{-t}}{1-x_0+x_0e^{-t}}$，当$t\rightarrow \infty$，根据不用的初始条件$x_0$，收敛到0或1，所以平衡点为$x=0$和$x=1$。
